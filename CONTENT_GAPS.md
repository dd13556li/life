...
- 垂直：比例佳
- 橫向：[x] ⭐社群媒體與比較（social_media_comparison，2026-06-11）、[ ] 享樂適應/快樂跑步機、[ ] hedonia vs eudaimonia
...
- 垂直：**L2 可補**
- 橫向：[ ] 龍樹/中觀「空」、[x] 《金剛經》（diamond_sutra，2026-06-11）、[ ] 唯識八識、[ ] 禪宗公案運用

## 8. 苦難與療癒（L1=3 L2=10 L3=1）⚠ 最頭重腳輕
- 垂直：⭐**L1 嚴重不足（只有3）**——最該補入門題
- 橫向（補在 L1）：[x] 如何面對失敗？（th4）、[ ] 慢性病痛/身體的苦、[ ] 後悔與「如果當初」、[x] 復原力（th5，2026-06-11）
...
- 垂直：⭐**L2 不足**
- 橫向（補在 L2）：[x] 一行禪師《和好》（buddhist_anger）、[x] 亞里斯多德「適當憤怒」（an1 金句＋納思邦 counterpoint 已涵蓋核心論辯）、[x] 演化心理學看憤怒（anger_neuroscience，2026-06-09已建）、[ ] 道家柔克剛
...
>
> 剩餘開放缺口（2026-06-11 盤點）：享樂適應、hedonia vs eudaimonia（幸福）；家庭親子之愛、分手與心碎（愛與關係）；社會角色與面具、文化/性別認同、社群媒體上的自我、米德（自我與認同）；龍樹中觀、唯識八識、禪宗公案（心經）；慢性病痛、後悔（苦難）；拖延、刻意練習（知行）；道家柔克剛（憤怒）；ACT、克爾凱郭爾《焦慮的概念》獨立卡（焦慮）；美學、遊戲、後真相、人與自然、語言形塑思想（其他）。
